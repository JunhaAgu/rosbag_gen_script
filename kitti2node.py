...
def main():
    ABS_PATH = "/home/junhakim/KITTI_odometry/dataset" #"/media/shapelim/UX960NVMe1/kitti_semantic/dataset"
    SAVE_PATH = "/home/junhakim/KITTI_odometry" #"/media/shapelim/UX960NVMe1/kitti_semantic/rosbag_final_ERASOR/seq05"
    ...
    parser.add_argument("-i", "--init_stamp", default=00, type=int) #000150.bin --> 149
    parser.add_argument("-itv", "--interval", default=1, type=int)
    parser.add_argument("-e", "--end_stamp", default=4540, type=int) #000250.bin --> 252
