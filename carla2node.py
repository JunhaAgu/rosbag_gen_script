...
def main():
    ABS_PATH = "/mnt/g/mapless_dataset/CARLA" #"/media/shapelim/UX960NVMe1/kitti_semantic/dataset"
    ...
    parser.add_argument("-s", "--sequence", default="01", choices=odometry_sequences, help="sequence of the odometry dataset (between 00 - 21), option is only for ODOMETRY datasets.")
